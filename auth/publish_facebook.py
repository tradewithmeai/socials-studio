...
def publish_facebook(
    ...
    with sync_playwright() as p:
        ...
        # profile's selectors ("What's on your mind", "Photo/video", "Processing", "Post") are
        # English strings, and Facebook renders them in whatever locale the browser reports if
        # the account itself carries no stored preference. See login_wizard.py's module docstring
        # for the live-confirmed failure this prevents on the other publishers.
